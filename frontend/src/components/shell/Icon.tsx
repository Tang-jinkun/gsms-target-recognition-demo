...
/**
 * Icon path data ported verbatim from open_design/assets/app.js (lucide, stroke-based).
 * Keeping the exact same paths guarantees identical glyphs to the static prototype.
 */
const I: Record<string, string> = {
  ...
  'folder-input': '<path d="M2 9V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H20a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H2"/><path d="M2 13h10"/><path d="m9 10 3 3-3 3"/>',
...
export default function Icon({ name, cls = '' }: { name: string; cls?: string }) {
  const paths = I[name] || ''
  return (
    <svg
...
/** String form, mirrors open_design/assets/app.js `icon()` — for imperative HTML (e.g. toast). */
export function iconHtml(name: string, cls = '') {
  const p = I[name] || ''
